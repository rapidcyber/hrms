    ...
    <body class="min-h-screen bg-gray-100 dark:bg-zinc-800">
        <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navlist variant="outline">
                <flux:navlist.group :heading="__('Payroll Managment System')" class="grid">
                    ...
                    <flux:navlist.item icon="banknotes" :href="route('month13')" :current="request()->routeIs('month13')" wire:navigate>{{ __('13th Month') }}</flux:navlist.item>
