<div>
    ...
    {{-- Confirm Delete --}}
    <x-modal wire:show="confirmDelete">
        <x-slot name="title">
            Delete Employee
        </x-slot>
        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        ...
        <x-slot name="footer">
            <button wire:click.prevent="$set('confirmDelete', false)" class="px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700">
                Cancel
            </button>
            <button wire:click.prevent="delete" class="ml-4 px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700">
                Delete
            </button>
